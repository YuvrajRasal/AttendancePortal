    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar>
          ...
          <Grid xs={12} >
          <Grid item >
          <List sx={{color:'black', display:'flex', flexDirection:'row',justifyContent:"space-between"}}>
            <>
            ...
            <ListItem className='Filter'>
               <ListItemButton sx={{border:"1.7px solid rgb(191, 189, 189)",borderRadius:"8px"
               ,paddingLeft:"12px",paddingRight:"12px",marginLeft:"15px",pt:"12px",pb:"12px"}}>
                <FilterAltIcon />
               </ListItemButton>
            </ListItem>
            </>
